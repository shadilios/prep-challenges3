...
const objLat = (obj) => {
    ...
    var firstLetterInFirstName = firstName[0].toUpperCase();

    let firstNameLength = firstName.length;

    var newFirstName = firstLetterInFirstName + firstName.slice(1, firstNameLength);
    ...
    var firstLetterInLastName = lastName[0].toUpperCase();

    let lastNameLength = lastName.length;

    var newLastName = firstLetterInLastName + lastName.slice(1, lastNameLength);

    console.log(newLastName);


    let output = `my name is ${newFirstName} ${newLastName} I am ${obj.age} YO, and I love ${obj.hobby}.`;
